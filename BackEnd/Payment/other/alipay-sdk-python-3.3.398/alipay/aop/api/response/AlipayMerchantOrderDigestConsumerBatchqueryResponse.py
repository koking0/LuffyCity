...
class AlipayMerchantOrderDigestConsumerBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMerchantOrderDigestConsumerBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMerchantOrderDigestConsumerBatchqueryResponse, self).parse_response_content(response_content)
